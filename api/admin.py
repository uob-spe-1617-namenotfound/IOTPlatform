...
def init_hardcoded_data():
    ...
    api.room_repository.add_room(house1.get_house_id(), "Kitchen")
    api.room_repository.add_room(house1.get_house_id(), "Bathroom")
    api.room_repository.add_room(house1.get_house_id(), "Living Room")
