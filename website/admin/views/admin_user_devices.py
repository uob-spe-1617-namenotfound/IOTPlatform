...
from forms import AddNewDeviceForm, SetThermostatTargetForm
...
def show_device(user_id, device_id, form=None):
    ...
    return render_template("admin/admin_deviceactions.html", device=device, triggers=triggers, actors=actors,
